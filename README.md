...
Setting the size of a static array in C++ is generally not allowed, and only works in this case becuase the
gcc-compiler is way too kind. The same code will not work on either Windows or Mac.
